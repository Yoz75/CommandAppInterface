...
internal class Program
{
    ...
    private const string ReflectionExample = "reflection";
    private static void Main(string[] args)
    {
        ...
        exampleChoiceInterface.AddCommand<string>(
            ...
            { AnsiConsole.Clear(); Run(exampleName); }, $"\"run [{MathExample}/{ExceptionExample}/{CMDExample}/{NoStyleExample}]/[{ReflectionExample}]\"")
            );
